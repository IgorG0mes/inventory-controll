...
class ProductOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_order" do
    assert_difference("ProductOrder.count") do
      post product_orders_url, params: { product_order: { description: @product_order.description, pallet: @product_order.pallet, product_id: @product_order.product_id, quantity: @product_order.quantity, user_id: @product_order.user_id } }
    end
  ...
  test "should update product_order" do
    patch product_order_url(@product_order), params: { product_order: { description: @product_order.description, pallet: @product_order.pallet, product_id: @product_order.product_id, quantity: @product_order.quantity, user_id: @product_order.user_id } }
